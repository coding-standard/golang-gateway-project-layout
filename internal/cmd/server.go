...
import (
	...
	"github.com/coding-standard/golang-project-layout/internal/gateway"
	"github.com/coding-standard/golang-project-layout/internal/gateway/grpc"
...
func GetServerCommand() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&cfgFile, "config", "./config/config.yaml", "config file (default is $HOME/.golang-project-layout.yaml)")
...
func InitConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".golang-project-layout")
	}
